...
func MessageNewApplication(pl *Pipeline, structure *Structure) (message *Message) {
	CMessage := C.gst_message_new_application((*C.GstObject)(unsafe.Pointer(pl.GstElement)), structure.C)
	message = &Message {
		C: CMessage,
	}
